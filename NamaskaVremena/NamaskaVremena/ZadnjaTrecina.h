...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// zora
			// 
			this->zora->Location = System::Drawing::Point(84, 41);
			this->zora->Name = L"zora";
			this->zora->Size = System::Drawing::Size(75, 20);
			this->zora->TabIndex = 12;
			this->zora->Validating += gcnew System::ComponentModel::CancelEventHandler(this, &ZadnjaTrecina::zora_Validating);
			// 
			// aksam
			// 
			...
			this->aksam->TabIndex = 11;
			this->aksam->Validating += gcnew System::ComponentModel::CancelEventHandler(this, &ZadnjaTrecina::aksam_Validating);
			// 
			// label1
			// 
			...
			this->ClientSize = System::Drawing::Size(204, 174);
...
private: System::Void izracunaj_Click(System::Object^  sender, System::EventArgs^  e) {
                  ...
                  sekundi_rezultat = sekundi_aksam + sekundi_trecina + sekundi_trecina;
				  ...
				  poruka->Text = "Zadnja treæina noæi poèinje od:";
